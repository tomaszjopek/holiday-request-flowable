package pl.itj.dev.holidaybpmnflowable.services;
...
public class HolidayService {
    ...
    public void deployProcessDefinition() {
        Deployment deployment =
                repositoryService
                        .createDeployment()
                        .addClasspathResource("processes/holiday-process.xml")
                        .deploy();
    }
    ...
    public List<TaskDetails> getManagerTasks() {
        var tasks = taskService.createTaskQuery().taskCandidateGroup(TASK_CANDIDATE_GROUP).list();
